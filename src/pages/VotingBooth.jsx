...
const VotingBooth = () => {
  ...
  const isImageSymbol = (symbol) => typeof symbol === 'string' && (symbol.startsWith('/') || symbol.startsWith('http'));
  ...
  const handleConfirmVote = async () => {
    ...
    if (result.success) {
      ...
      setVoteError(result.message || 'Vote could not be submitted. Please try again.');
    }
      ...
      <div className="voting-booth-page">
        <div className="booth-container">
          <div className="phase-notice">
            ...
            <button onClick={() => navigate('/citizen/verify')} className="btn-verify-first">
              Verify Identity
            </button>
          </div>
        </div>
      ...
      <div className="booth-container">
        ...
        {!voteSuccess ? (
          <>
            ...
            <div className="candidates-section">
              ...
              <div className="candidates-grid">
                {constituencyCandidate.map((candidate) => (
                  ...
                  >
                    <div className="candidate-photo" style={{ background: candidate.color }}>
                      {isImageSymbol(candidate.symbol) ? (
                        <img src={candidate.symbol} alt={`${candidate.partyShort || candidate.party} symbol`} className="symbol-image" />
                      ) : (
                    ...
                    <div className="symbol-box" style={{ borderColor: candidate.color }}>
                      {isImageSymbol(candidate.symbol) ? (
                        <img src={candidate.symbol} alt={`${candidate.partyShort || candidate.party} logo`} className="symbol-box-image" />
                      ) : (
                ...
                <div
                  ...
                  onClick={() => handleCandidateSelect({ id: 'NOTA', name: 'NOTA', party: 'None of the Above', symbol: '/party-symbols/nota.svg' })}
                >
                  <div className="candidate-photo nota-photo">
                    <img src="/party-symbols/nota.svg" alt="NOTA symbol" className="symbol-image" />
                  </div>
                  <div className="candidate-info">
                    <h3>NOTA</h3>
            ...
            {voteError && (
              <div className="confirm-dialog" role="alert">
